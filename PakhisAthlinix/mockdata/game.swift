...
var games: [Game] = [
    Game(gameID: "game1", team1ID: "1", team2ID: "2", dateOfGame: Date(), venue: "Arena 1", finalScore: ""),
    Game(gameID: "game2", team1ID: "3", team2ID: "4", dateOfGame: Date(), venue: "Stadium 1", finalScore: ""),
    Game(gameID: "game3", team1ID: "5", team2ID: "1", dateOfGame: Date(), venue: "Arena 2", finalScore: ""),
    Game(gameID: "game4", team1ID: "2", team2ID: "3", dateOfGame: Date(), venue: "Stadium 2", finalScore: ""),
    Game(gameID: "game5", team1ID: "4", team2ID: "5", dateOfGame: Date(), venue: "Arena 3", finalScore: "")
]
...
var gameLogs: [GameLog] = [
    ...
    GameLog(logID: "log18", gameID: "game5", teamID: "4", playerID: "2", points2: 11, points3: 1, freeThrows: 2, rebounds: 5, assists: 3, steals: 0, fouls: 0, missed2Points: 0, missed3Points: 1),
