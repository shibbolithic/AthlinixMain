...
struct GamePointsChartView: View {
    ...
    private func latestGameLogs() -> [GameLogtable] {
        ...
        return Array(sortedLogs.prefix(8)) // Take only the latest 5 games
    }
...
struct GamePointsChartView_Previews: PreviewProvider {
