...
class CoachUserViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
extension CoachUserViewController: UICollectionViewDelegate, UICollectionViewDataSource {
